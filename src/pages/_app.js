  ...
  useEffect(()=> {
    const getCollections =async() => {
      ...
      try {
        // http://54.159.18.143
// http://54.159.18.143
        const res = await axios.get('https://ec2-54-159-18-143.compute-1.amazonaws.com:3000/api/collections');
  ...
  useEffect(()=> {
    const getCollections =async() => {
      ...
      try {
        const res = await axios.get('https://ec2-54-159-18-143.compute-1.amazonaws.com:3000/api/users');
